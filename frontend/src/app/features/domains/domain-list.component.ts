          ...
          <ng-container matColumnDef="actions">
            ...
            <td mat-cell *matCellDef="let item">
              <a
                mat-button
                color="primary"
                [routerLink]="['/admin/domains', item.id, 'edit']"
                [attr.aria-label]="'Edit ' + item.domain"
              >
              ...
              <button
                ...
                [attr.aria-label]="(item.isActive ? 'Deactivate ' : 'Reactivate ') + item.domain"
              >
              ...
              <button
                ...
                (click)="remove(item)"
                [disabled]="facade.saving()"
                [attr.aria-label]="'Delete ' + item.domain"
              >
